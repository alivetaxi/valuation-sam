            ...
            if len(tr.find_all()) == 7:
                ...
                if company is None:
                    ...
                    if (
                        ...
                        or industry != company["industry"]
                    ):
                        table.update_item(
                            Key={"company_id": co_id},
                            AttributeUpdates={
                                "company_name": {"Value": name, "Action": "PUT"},
                                "industry": {"Value": industry, "Action": "PUT"},
                            },
                        )
                    companies.pop(co_id)

    for company in companies:
        table.delete_item(Key={"company_id": company["company_id"]})
